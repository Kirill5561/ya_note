...
"""залогиненного пользователя должно переадресовать
...
"""POST-запроса анонимного пользователя должно
...
"""Теперь протестируем возможность
создать две заметки с одинаковым slug"""
...
"""Следующий тест: если при создании заметки оставить поле slug
пустым — то содержимое этого поля будет сформировано
автоматически, из содержимого поля title."""
...
"""Подобным же образом проверяем, что зарегистрированный
